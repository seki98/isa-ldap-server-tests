...
#1 get all entries
ldapsearch -h $1 -p $2  -x -P 2 -s base "uid=x*" > tests/out.1 2>&1 &

#2 get one entry xkisel02
ldapsearch -h $1 -p $2  -x -P 2 -s base "uid=xkisel02" > tests/out.2 2>&1 &

#3 get nothing
ldapsearch -h $1 -p $2 -x -P 2 -s base "uid=xkisel" > tests/out.3 2>&1 &
...
ldapsearch -h $1 -p $2 -x -P 2 -s base "uid<=x" > tests/out.7 2>&1 &
...
#9 get max 5 results
ldapsearch -h $1 -p $2 -x -P 2 -s base -z 5 "uid=x*" > tests/out.9 2>&1 & 

#10 get unlimited results
ldapsearch -h $1 -p $2 -x -P 2 -s base -z 0 "uid=x*" > tests/out.10 2>&1 &

#11 find 442 - everyone except mr. Thanh
ldapsearch -p $2 -h $1 -P 2 -s base -x '(!(|(&(cn=*Thanh)(uid=xdolon00))(&(cn=Tomas)(mail=xtomas0@email.cz))))' > tests/out.11 2>&1 &
